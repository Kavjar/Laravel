...
class UserController extends Controller
{
    ...
    public function update(UpdateUserRequest $request, User $user)
    {
        ...
        if ($validated->input('name'))
            $updatePayload[] = $validated->input('name');

        if ($validated->input('email'))
            $updatePayload[] = $validated->input('email');

        if ($validated->input('password'))
            $updatePayload[] = $validated->input('password');
